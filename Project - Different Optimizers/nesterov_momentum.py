...
while i<N: #i<len(x_train): 
    ...
    momentumW1 = gamma*momentumW1 + eta*dL_dW1W1
    
    W1new = np.array(tf.math.subtract(W1, momentumW1), np.double)
    ...
    momentumW2 = gamma*momentumW2 + eta*dL_dW2W2
    
    W2new = np.array(tf.math.subtract(W2, momentumW2), np.double)
